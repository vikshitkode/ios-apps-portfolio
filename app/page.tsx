                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={skill}
                        className="skill-tag-gradient px-3 py-1 text-xs rounded-full"
                      >
                        {skill}
                      </span>
                    ))}
        ...
        >
          <div className="space-y-16">
            ...
            <div className="space-y-12">
              {[
                // --- NEW: iOS Developer Uber (most recent) ---
                {
                  year: "Apr 2026 — Present",
                  role: "iOS Developer",
                  company: "Uber Technologies Inc.",
                  description:
                    "Building scalable UIKit features using Uber’s RIBs architecture for the Earners App, including authentication flows, local persistence, and push notifications. Followed Apple HIG and modular design principles, shipped iteratively to production, wrote XCTest unit/UI tests, and improved app stability through Firebase Crashlytics monitoring and targeted fixes.",
                  tech: [
                    "Swift",
                    "UIKit",
                    "RIBs",
                ...
                // --- UPDATED: Mobile Developer Intern ---
                {
                  year: "Feb 2025 — Mar 2025",
                  role: "Mobile Developer Intern",
                  company: "Sports Excitement LLC",
                  description:
                    "Developed cross-platform mobile features using React Native, building Authentication flows and GearHub screens. Implemented user login/signup experiences, managed state, and collaborated with backend APIs to deliver responsive and scalable UI components.",
                  tech: [
                    "React Native",
                    "JavaScript",
                    "Authentication",
                ...
                // --- NEW: iOS Developer Intern ---
                {
                  year: "Oct 2025 — Feb 2025",
                  role: "iOS Developer Intern",
                  company: "Alervio Inc.",
                  description:
                    "Building SwiftUI features (MVVM) including auth, local persistence, and push notifications following Apple HIG. Shipped iteratively to TestFlight/App Store, wrote XCTest unit/UI tests, and improved stability via Firebase Crashlytics monitoring and targeted fixes.",
                  tech: [
                    "Swift",
                    "SwiftUI",
                    "MVVM",
                ...
                <div
                  key={index}
                  className="group card-gradient-border grid lg:grid-cols-12 gap-8 py-8 rounded-lg px-6"
                >
                ...
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className=" leading-relaxed">
                      A comprehensive fitness tracking app that motivates users
                      to stay active with step counting, goal setting, and
                      social challenges. Built with HealthKit integration for
              ...
              <article className="group card-gradient-border p-8 rounded-lg">
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className=" leading-relaxed">
                      Classic card game reimagined for iOS with smooth
                      animations, multiplayer support, and engaging gameplay.
                      Features custom card designs and intuitive touch controls.
                    </p>
                  </div>
              ...
              <article className="group card-gradient-border p-8 rounded-lg">
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className=" leading-relaxed">
                      On-device recipe generator powered by Apple’s Foundation
                      Models. Turn a few ingredients into beautiful step-by-step
                      recipes private, fast, offline.
                    </p>
                  </div>
              ...
              <article className="group card-gradient-border p-8 rounded-lg">
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="leading-relaxed">
                      Meet MyCat, your cheerful companion that brings you a new
                      cat every day, adorable photos, fun facts, and lovable
                      personalities all in one beautifully designed app.
                    </p>
                  </div>
              ...
              <article className="group card-gradient-border p-8 rounded-lg">
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className=" leading-relaxed">
                      Consulting companion app showcasing services, contact, and
                      quick actions built with SwiftUI and shipped to the App
                      Store.
                    </p>
                  </div>
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      onClick={(e) => {
                        console.log(
                          "[v0] Seatech Solutions App Store link clicked",
                        );
                        console.log("[v0] Link href:", e.currentTarget.href);
                      }}
                      className="inline-flex items-center gap-2 text-sm group-hover:text-foreground transition-all duration-300 hover:scale-105 relative z-10 cursor-pointer"
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-xl  leading-relaxed">
                  Always interested in new iOS projects, collaborations, and
                  conversations about mobile development.
                </p>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            <div className="space-y-2">
              <div className="text-sm ">
                © Sai Vikshit Kode. All rights reserved.
              </div>
            </div>
